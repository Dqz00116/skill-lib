...
### ⚠️ 重要提醒：更新 SUMMARY.md

**上传新 Skill 后，必须更新 [SUMMARY.md](./SUMMARY.md) 文件：**

1. **在概览表格中添加新 Skill** - 包含名称、描述、复杂度、耗时、收益
2. **在详细对比章节添加完整描述** - 包含用途、适用场景、输入输出等
3. **在快速选择表格中添加条目** - 方便用户根据需求查找

**SUMMARY.md 是用户发现和选择 Skill 的主要入口，保持其完整性和时效性至关重要。**
